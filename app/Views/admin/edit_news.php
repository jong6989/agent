                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card ">
                                    ...
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form class="form" method="post" action="<?= $formUrl ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body px-5">
                                            <img class="img-responsive" src="<?= base_url('images/' . $newsToEdit['img_path']) ?>" alt="" width="128px" height="250px">
