                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a href="<?= base_url('operator_news') ?>" class="my-2 btn btn-primary">Add news</a>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                                ...
                                                <?php if (!empty($allOperatorNews)) : ?>
                                                    ...
                                                    <?php foreach ($allOperatorNews as $news) : ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?= base_url('operator_news?edit=' . $news['id']) ?>" class="btn btn-warning btn-xs">
                                                                    <i class="fas fa-edit"></i>
                                                                    Edit
                                                                </a>

                                                                <form action="<?= base_url('operator_news'); ?>" method="post">
