            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Release SHARE for: <strong><?= $currentItem['name']; ?></strong> </h3>
                    </div>
                    <div class="card-header">
                      <h3 class="card-title">Maximum Release: <strong><?= PESO . ' ' . number_format($currentItem['wallet']); ?></strong> </h3>
                    </div>
                    <div class="card-header">
                      <h3 class="card-title">Minimum Release: <strong><?= PESO . ' ' . number_format($minimum_payout); ?></strong> </h3>
                    </div>
                    <div class="card-body">
